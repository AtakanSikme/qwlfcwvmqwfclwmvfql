...
await message.guild.channels.create('Private Odaları', { type: "category" }).then(a => {
a.createOverwrite(message.guild.roles.cache.find(a => a.name === "@everyone"), {
 SEND_MESSAGES: false,
 VIEW_CHANNEL: false,
 READ_MESSAGE_HISTORY: false
...
await message.guild.channels.create("「🌠」Private", {type: "voice", parent: message.guild.channels.cache.find(a => a.name === 'Private Odaları').id})
  await message.guild.channels.create("「🌠」Private", {type: "voice", parent: message.guild.channels.cache.find(a => a.name === 'Private Odaları').id})
  await message.guild.channels.create("「🌠」Private", {type: "voice", parent: message.guild.channels.cache.find(a => a.name === 'Private Odaları').id})
  await message.guild.channels.create("「🌠」Private", {type: "voice", parent: message.guild.channels.cache.find(a => a.name === 'Private Odaları').id})
  await message.guild.channels.create("「🌠」Private", {type: "voice", parent: message.guild.channels.cache.find(a => a.name === 'Private Odaları').id})
